...
clientId = Parameter("aApiUser")
clientSecret = Parameter("aApiSecret")
...
outFile.WriteLine "clientId: " + clientId
outFile.WriteLine "clientSecret: " + clientSecret

outFile.WriteLine vbCrLf & "Test ID: " + test.Id
